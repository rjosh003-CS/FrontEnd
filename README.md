...
```
cd existing_repo
git remote add origin https://gitlab.com/rjosh003-CS/eventsolution.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/rjosh003-CS/eventsolution/-/settings/integrations)
...
#### Using terminal. Go to the folder:
